...
describe('Pagination', () => {
  describe('when render default state', () => {
    it('should render two buttons', async () => {
      ...
      render(
        <Pagination
          p={{ prev: null, next: 'next', count: 20, pages: 2 } as PaginationInfo}
          onP={onPreviousPageMock}
          onN={onNextPageMock}
        />
      );
    ...
    describe('when click on next link', () => {
      it('should call onNextPage', async () => {
        ...
        render(
          <Pagination
            p={{ prev: 'prev', next: 'next', count: 20, pages: 2 } as PaginationInfo}
            onP={onPreviousPageMock}
            onN={onNextPageMock}
          />
        );
  ...
  describe('when render without next link', () => {
    it('should render next button as disabled', async () => {
      ...
      render(
        <Pagination
          p={{ prev: 'prev', next: null, count: 20, pages: 2 } as PaginationInfo}
          onP={onPreviousPageMock}
          onN={onNextPageMock}
        />
      );
